...
function parseCategory(category) {
  const { _id, name, slug, display_name } = category;
  ...
  const returnObj = {
    ...
    content: {
      type: "atom",
      rel: "self",
      src: `apdotstudiopro://fetchData?type=channels&category=${slug}`, //formatted url to retrieve this category's channels inside the Zapp app
    },
    link: {
      rel: "self",
      type: "feed",
      href: `apdotstudiopro://fetchData?type=channels&category=${slug}`,
    },
  };
